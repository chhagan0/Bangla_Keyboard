...
public final class ActivityThemeBinding implements ViewBinding {
  ...
  private ActivityThemeBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivBack,
      @NonNull RecyclerView themeRV, @NonNull RelativeLayout toolbarRl) {
    this.rootView = rootView;
    this.ivBack = ivBack;
    this.themeRV = themeRV;
  ...
  public static ActivityThemeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.themeRV;
      RecyclerView themeRV = ViewBindings.findChildViewById(rootView, id);
      if (themeRV == null) {
        break missingId;
      }
      ...
      return new ActivityThemeBinding((LinearLayout) rootView, ivBack, themeRV, toolbarRl);
    }
